...
class  MiPDF extends FPDF 
{
	...
	public function Header()
	{
		...
		$this -> Cell( 150, 20 , "BD: siglagranja / PlagaEnfermedad-Vegetal   ", 0 , 0 , 'C' );						
...
$mipdf->SetMargins(48, 25, 25, 10); //Margenes de: Izquierda,Arriba,Abajo,Derecha
$mipdf->SetAutoPageBreak(true,25);
$cabecera = array("CODIGO");
$cabecera1 = array("PLAGA-ENFERMEDAD");
$cabecera2 = array("VEGETAL");
...
while($reg=pg_fetch_array($res))
{
	...
	$mipdf -> Cell( 25, 10 , $codigo, 1, 0, 'R' , true );
	$mipdf -> SetFillColor( 255,255,255);
	$mipdf -> Cell( 100, 10 , $nomcomun, 1, 0, 'L' , true );
	$mipdf -> SetFillColor( 255,255,255);		
	$mipdf -> Cell( 50, 10 , $nomcomun1, 1, 0, 'L' , true );
	$mipdf -> SetFillColor( 255,255,255);
	$mipdf -> Ln( 10);	
}   
$mipdf -> Output('Pdf_PlagaEnfermedadVegetal.pdf','I');//Nombre de descarga y Tipo de Visualización
?>
