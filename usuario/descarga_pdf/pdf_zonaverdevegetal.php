...
$mipdf->SetMargins(4, 25, 25, 7); //Margenes de: Izquierda,Arriba,Abajo,Derecha
...
$mipdf -> Output('Pdf_ZonaverdeVegetal.pdf','I');//Nombre de descarga y Tipo de Visualización
?>
