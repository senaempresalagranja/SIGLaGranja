...
class  MiPDF extends FPDF 
{
	...
	public function Header()
	{
		...
		$this -> Cell( 180, 20 , "BD: siglagranja / Unidad-Canal   ", 0 , 0 , 'C' );						
...
$mipdf->SetMargins(10, 25, 25, 10); //Margenes de: Izquierda,Arriba,Abajo,Derecha
$mipdf->SetAutoPageBreak(true,25);
$cabecera = array("CODIGO");
$cabecera1 = array("UNIDAD");
$cabecera2 = array("CANAL");
$cabecera3 = array("DISTANCIA");
$mipdf -> addPage('A5' , 'letter',20,39);////Orientación de la pagina (Horizontalmente "legal"), (Verticalmente "letter")
...
for ($i = 0; $i < count( $cabecera3 ) ; $i++)
{
	...
	$mipdf -> SetTextColor( 255, 255 ,255);
	$mipdf -> SetFillColor(  0 , 0 ,255);
	$mipdf -> Cell ( 35, 10 , $cabecera3[ $i ] , 1 , 0 , 'C' , true );	
}
$mipdf -> Ln( 10);
...
$res=pg_query($con, "SELECT * FROM unidad_canal ORDER BY cunkidcodigo ASC");
	...
	$mipdf -> Cell( 100, 10 , $nombre, 1, 0, 'L' , true );
	$mipdf -> Cell( 100, 10 , $nombre1, 1, 0, 'L' , true );
	$mipdf -> Cell( 17.5, 10 , $distancia, 1, 0, 'R' , true );
	$mipdf -> Cell( 17.5, 10 , $nombre2, 1, 0, 'L' , true );
	$mipdf -> Ln( 10);	
}   
$mipdf -> Output('Pdf_UnidadCanal.pdf','I');//Nombre de descarga y Tipo de Visualización
?>
